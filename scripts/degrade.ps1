...
if (Test-Path $ScratchPython) {
    ...
    throw "No project Python found. Create a venv or update scripts\degrade.ps1 with your venv path."
}

Write-Host "Using Python: $Python"
& $Python (Join-Path $ProjectRoot "scripts\run_degradation_study.py") @Args
